...
export default function Terms() {
    return (
        <>
            <Head>
                <title>pricemymeds - Terms and Conditions</title>
                <meta name="description" content="Read the terms and conditions for using pricemymeds. Find out about our drug discount cards and pricing disclaimers." />
                    ...
                    <div className="bg-white rounded-2xl shadow-sm border border-border/40 p-6 md:p-10 space-y-10">
                        ...
                        <div className="bg-[#B84040]/5 border-l-4 border-[#B84040] p-6 rounded-r-xl space-y-3">
                            ...
                            <p className="text-sm text-[#1A1C2E] leading-relaxed">
                                pricemymeds is <strong>NOT</strong> insurance and is <strong>NOT</strong> a substitute for health insurance or government healthcare programs. It does not meet minimum creditable coverage requirements under state or federal laws. The coupons and drug discount cards optimized on pricemymeds are <strong>free prescription discount programs</strong>. You are solely responsible for paying the entire cost of the discounted medication at the pharmacy counter.
                            </p>
                        </div>
                        ...
                        <section className="space-y-4">
                            ...
                            <p className="text-[17px] leading-relaxed text-[#1A1C2E]/90">
                                By accessing, browsing, or using the pricemymeds platform (including our website, services, and search tools), you agree to be bound by these Terms and Conditions and all applicable laws and regulations. If you do not agree to these terms, you are not authorized to use this website.
                            </p>
                        </section>
                        ...
                        <section className="space-y-4">
                            ...
                            <p className="text-[17px] leading-relaxed text-[#1A1C2E]/90">
                                pricemymeds and its affiliates, partners, and data suppliers (including NeedyMeds) are not responsible or liable for any direct, indirect, incidental, or consequential damages resulting from your use or inability to use our platform, or from reliance on any information provided on this website.
                            </p>
                        </section>
                        ...
                        <section className="space-y-4">
                            ...
                            <p className="text-[17px] leading-relaxed text-[#1A1C2E]/90">
                                These Terms and Conditions and any disputes arising out of or related to your use of pricemymeds will be governed by and construed in accordance with the laws of the United States and the State of Delaware, without giving effect to conflict of law principles.
                            </p>
                        </section>
                        ...
                        <section className="space-y-4">
                            ...
                            <div className="bg-[#FAFAFA] rounded-xl p-5 border border-border/40">
                                <p className="font-bold text-[#1A1C2E]">pricemymeds Support Team</p>
                                <p className="text-sm text-[#6A6C7D] mt-1">Email: support@pricemymeds.com</p>
