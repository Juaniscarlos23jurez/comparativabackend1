...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::post('/api/programs', function (\Illuminate\Http\Request $request) {
        ...
        $dbQuery = \App\Models\AssistanceProgram::where('is_national', $isNational);
    ...
    Route::post('/api/coupons', function (\Illuminate\Http\Request $request) {
        $rows = (int) $request->input('rows', 10);
        $page = (int) $request->input('page', 0);
        $order = $request->input('order', 'ASC');
        ...
        $dbQuery = \App\Models\DiscountCoupon::query();
    ...
    Route::post('/api/diagnoses', function (\Illuminate\Http\Request $request) {
        ...
        $dbQuery = \App\Models\Diagnosis::query();
    ...
    Route::post('/api/clinics', function (\Illuminate\Http\Request $request) {
        ...
        $dbQuery = \App\Models\Clinic::query();
        ...
        if (!empty($postalCode)) {
            $zipClinic = \App\Models\Clinic::where('postal_code', $postalCode)->first();
